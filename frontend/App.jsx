...
import { useGetRefreshToken } from '@hooks/queries/useAuth';
...
function App() {
  // const refreshTokenQuery = useGetRefreshToken(); // 함수 호출 추가
  // const isLoading = refreshTokenQuery.isLoading;
  // const isLoggedIn = refreshTokenQuery.isSuccess;
  // const isLoggedIn = useAuth();
  const isLoggedIn = true;

  // if (isLoading) {
  //   return <CustomText>Loading...</CustomText>; // 로딩 상태 표시
  // }
